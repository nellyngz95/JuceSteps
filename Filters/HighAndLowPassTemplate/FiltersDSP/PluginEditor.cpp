...
//==============================================================================
FiltersLab2AudioProcessorEditor::FiltersLab2AudioProcessorEditor (FiltersLab2AudioProcessor& p)
...
FiltersLab2AudioProcessorEditor::~FiltersLab2AudioProcessorEditor()
{
}

//==============================================================================
void FiltersLab2AudioProcessorEditor::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
        ...
        g.drawFittedText ("EQ 2", headerArea, juce::Justification::centred, 1);
}

void FiltersLab2AudioProcessorEditor::resized()
{
